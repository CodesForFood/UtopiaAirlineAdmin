...
import com.smoothstack.airlineAdmin.dao.TravelerDAO;
...
public class TravelerService {
	...
	@Autowired
	private TravelerDAO travelDAO;
	
	@Transactional
	public List<Traveler> getAllTravelers(int size) {
		Pageable limit = PageRequest.of(0,size);
		return travelDAO.findAll(limit).getContent();		
	}
