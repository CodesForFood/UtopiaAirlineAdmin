...
import com.smoothstack.airlineAdmin.dao.CounterDAO;
...
public class CounterService {
	...
	@Transactional
	public Counter createCounter(Counter traveler) {
		return counterDAO.save(traveler);
	}	

	@Transactional
	public Counter updateCounter(Counter traveler) {
		return counterDAO.save(traveler);
	}	
}
